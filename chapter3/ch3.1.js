...
alert(`I did not spend much time on this code because the description/explanation in the text was minimal & downplays the importance.

The sample code also throws a CORS error that is not mentioned online anywhere which hints that the purpose of the examples is moot.

I feel it better to progress to the second part of the book building the use case app.`);